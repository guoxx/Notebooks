...
class LTC(object):
    ...
    def test_normalization(self):
        norm = sph.spherical_integral(self.eval, num_samples=1024)
        # print("ltc pdf integration ", sph.spherical_integral(self.pdf, num_samples=1024))
        err = abs(norm - 1)
        if err > 0.01:
            raise ValueError("LTC normalization failed")
